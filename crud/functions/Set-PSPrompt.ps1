...
"@
        ...
        #region message to implement custom prompt

        Write-Host "OK, That's all the questions done."
        Write-Host "We have saved your responses to a file and now you need to push this change to become your active PowerShell prompt"
        write-verbose "Prompt choices saved in $WorkingFolder\PSPrompt.config"
        Write-Host ""
        Write-Host "Please execute the command Set-PSPrompt to make it happen!"
        write-host ""
        #endregion
    }
